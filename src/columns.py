...
ignore_cols = ('annual_inc_joint', 'collection_recovery_fee', 'desc', 'funded_amnt', 'funded_amnt_inv', 'id', 'last_credit_pull_d',
               ...
               'verification_status_joint', 'open_il_6m', 'emp_title', 'dti_joint', 'last_pymnt_d')
...
# Columns where we want to fill in the missing values with 0.
fill_zero_cols = ('num_sats', 'num_rev_tl_bal_gt_0', 'num_rev_accts', 'num_op_rev_tl', 'num_il_tl', 'num_bc_tl', 'num_bc_sats',
                  'num_accts_ever_120_pd', 'num_actv_bc_tl', 'num_tl_30dpd', 'inq_last_12m', 'acc_open_past_24mths',
                  'open_rv_24m', 'open_acc_6m', 'open_il_6m', 'open_il_12m', 'open_il_24m', 'total_bal_il',
                  'open_rv_12m', 'inq_fi', 'emp_length', 'pub_rec_bankruptcies', 'avg_cur_bal', 'num_tl_120dpd_2m',
                  'revol_util', 'total_rev_hi_lim', 'total_il_high_credit_limit', 'tot_cur_bal', 'tot_coll_amt',
                  'tot_hi_cred_lim', 'bc_util', 'percent_bc_gt_75', 'bc_open_to_buy', 'mort_acc', 'total_bc_limit',
                  'total_bal_ex_mort', 'revol_util', 'collections_12_mths_ex_med', 'tax_liens', 'chargeoff_within_12_mths',
                  'il_util', 'all_util', 'open_acc_6m', 'open_il_6m', 'open_il_12m', 'open_il_24m', 'total_bal_il',
                  'open_rv_12m', 'open_rv_24m', 'max_bal_bc', 'inq_fi', 'total_cu_tl', 'inq_last_6mths')

# Columns where we want to fill in the missing values with 360.
fill_360_cols = ('mths_since_recent_inq', 'mo_sin_old_il_acct', 'mo_sin_old_rev_tl_op', 'mo_sin_rcnt_rev_tl_op',
                 'mo_sin_rcnt_tl', 'mths_since_recent_bc', 'mths_since_rcnt_il', 'mths_since_last_record', 
